...
ZenvaRunner.MainMenu.prototype = {
  create: function() {
    ...
    this.game.add.tween(this.player).to({y: this.player.y - 16}, 700, Phaser.Easing.Linear.NONE, true, 0, Infinity, true);

    this.splash = this.add.sprite(this.game.world.centerX, this.game.world.centerY, 'logo');
    this.splash.anchor.setTo(0.5);

    this.startText = this.game.add.bitmapText(0,0, 'minecraftia', 'Tab to Start!', 32);
